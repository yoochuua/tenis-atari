...
void Player2::initializeGL(GLuint program) {
  terminateGL();
  createPlayer2(program);
  m_translation.x = -0.8f;
  m_translation.y = 0.0f;
}
void Player2::paintGL(const GameData &gameData) {
...
void Player2::terminateGL() {
  abcg::glDeleteBuffers(1, &m_vbo);
  abcg::glDeleteBuffers(1, &m_ebo);
  abcg::glDeleteVertexArrays(1, &m_vao);
}
void Player2::update(const GameData &gameData, bool isPlayer) {
